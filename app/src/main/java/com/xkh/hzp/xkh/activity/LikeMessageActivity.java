...
import com.xkh.hzp.xkh.adapter.LikeMessageAdapter;
 ...
 * @FileName LikeMessageActivity
 * @Author tangyang
 * @DATE 2018/6/9
 **/
public class LikeMessageActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {

    private SwipeRefreshLayout talentClassSwipefreshLayout;
    private RecyclerView talentClassRecyclerView;
    private LikeMessageAdapter commentMessageAdapter;
    ...
    public void initView() {
        ...
        commentMessageAdapter = new LikeMessageAdapter();
        EmptyView emptyView = new EmptyView(this);
        emptyView.setNodataTitle("暂无用户点赞");
    ...
    private void initData(final int pageNum, int pageSize) {
        ...
        ABHttp.getIns().get(UrlConfig.messagelike, params, new AbHttpCallback() {
            @Override
            public void setupEntity(AbHttpEntity entity) {
                super.setupEntity(entity);
                entity.putField("result", new TypeToken<List<LikeMessageResult>>() {
                }.getType());
            }
