...
import xkh.hzp.xkh.com.base.model.AbAppProcessInfo;
import xkh.hzp.xkh.com.base.model.AbCPUInfo;
import xkh.hzp.xkh.com.base.model.AbProcessInfo;
import xkh.hzp.xkh.com.base.model.AbPsRow;
...
public class AbAppUtil {
    ...
    public static AbProcessInfo getMemInfo(String processName) {
        ...
        if (process.memory == 0) {
            Log.d(AbAppUtil.class.getName(), "##" + processName + ",top -n 1未找到");
        }
        return process;
    }
    ...
    public static String runCommand(String[] command, String workdirectory) {
        String result = "";
        Log.d(AbAppUtil.class.getName(), "#" + command);
        try {
    ...
    public static long getTotalMemory(Context context) {
        ...
        try {
            ...
            for (String str : strs) {
                Log.d(AbAppUtil.class.getName(), str + "\t");
            }
            //获得系统总内存，单位KB  
